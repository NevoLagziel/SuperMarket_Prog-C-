...
int		initSuperMarket(SuperMarket* pMarket, const char* fileName, const char* cumpressedFileName,
						const char* customersFileName, const int fileType)
{
	...
	if (loadSuperMarket(pMarket, fileName, cumpressedFileName, customersFileName, fileType) == 1)
	{
